# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-17 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('string', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='translate.String')),
            ],
        ),
        migrations.CreateModel(
            name='Translator',
        ...
        migrations.AlterUniqueTogether(
            name='suggestion',
            unique_together=set([('string', 'value', 'plural_form')]),
        ),
        migrations.AlterUniqueTogether(
            name='string',
